...
const BottomSectionInfo = ({ product }) => {
        ...
        <div className="card card-compact bg-base-100 shadow-xl rounded-xl">
            ...
            <div className="card-body">
                ...
                <div className="card-actions justify-center mt-3">
                    <button className="btn btn-wide bg-gradient-to-r from-accent to-red-500 border-0 btn-xs sm:btn-sm md:btn-md font-sans font-bold"><Link className='text-white' to={`/purchase/${product._id}`}>Determine</Link> </button>
                </div>
            </div>
        </div>
    );
